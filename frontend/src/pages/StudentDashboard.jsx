                    ...
                    <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                      ...
                      <div className="space-y-4">
                        {courses.map((course) => (
                          <div
                            key={course.id}
                            className="bg-white/5 rounded-xl p-4 hover:bg-white/10 transition-all duration-200 group cursor-pointer"
                          >
                    ...
                    <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                      ...
                      <div className="space-y-4">
                        {[
                          {
                            type: "assignment",
                            title: "Submitted Advanced Algorithms Project",
                            time: "2 hours ago",
                            status: "success",
                          },
                          {
                            type: "course",
                            title: "Completed Machine Learning Module 5",
                            time: "1 day ago",
                            status: "success",
                          },
                          {
                          ...
                          {
                            type: "reminder",
                            title: "Database project due in 3 days",
                            time: "3 days ago",
                            status: "warning",
                          },
                        ].map((activity, i) => (
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-white/10">
                          ...
                          <th className="text-right py-3 text-white/60 font-medium">
                            Actions
                          </th>
                        </tr>
                      </thead>
