...
export default function TeacherDashboard() {
  ...
  const [teacher, setTeacher] = useState({
    ...
    avatar:
      "https://imgs.search.brave.com/8uciZ52LLwRZDYI3NRZbkbPzwRjzgOT6c07eDcRy5YI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvMjE2/MDQ3Mzk2MC9waG90/by9oYXBweS1zYXRp/c2ZpZWQtbWF0aC10/ZWFjaGVyLWluLWVs/ZW1lbnRhcnktY2xh/c3Mud2VicD9hPTEm/Yj0xJnM9NjEyeDYx/MiZ3PTAmaz0yMCZj/PTg4U1JITWVBb3pP/MjIxZ2V0anp3RGJY/TUJLSHlZTjdxRWJH/V1RaUEhWN0E9",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex h-screen">
        ...
        {/* Sidebar */}
        <div
          className={`fixed lg:relative inset-y-0 left-0 z-50 w-72 bg-white/10 backdrop-blur-xl border-r border-white/20 transform transition-transform duration-300 ease-in-out ${
            isSidebarOpen
              ? "translate-x-0"
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white/60">
                    You have 2 new assessments to review today
                  </p>
                </div>
              </div>
                  ...
                  <div className="lg:col-span-2 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800 rounded-2xl p-8 text-white relative overflow-hidden">
                    <div className="relative z-10">
                      ...
                      <p className="text-lg mb-2 text-white/90">
                        You have 2 new assessments added to your subjects.
                      </p>
                    ...
                    <div className="absolute right-8 top-8 flex space-x-2 opacity-30">
                      {[...Array(6)].map((_, i) => (
                        <div
                          key={i}
                          className="w-10 h-16 bg-white/20 rounded-full flex items-center justify-center"
                        >
                          <div
                        ...
                        >
                          <div>
                            ...
                            <div className="text-xs text-white/60">
                              {cls.assessed} Students Assessed
                            </div>
                          </div>
                          <div className={`text-lg font-bold ${cls.color}`}>
                            {cls.percentage}%
                          </div>
                        </div>
                      ))}
                  ...
                  <div className="lg:col-span-1 bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                    ...
                    <div className="space-y-3">
                      {students.slice(0, 3).map((student, i) => (
                        <div
                          key={student.id}
                          className={`p-4 rounded-xl flex items-center justify-between transition-all duration-200 hover:scale-105 ${
                            i === 0
                    ...
                    <div className="grid grid-cols-7 gap-1 text-center">
                      {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
                        (day) => (
                          <div
                            key={day}
                            className="font-medium text-white/60 p-3 text-sm"
                          >
                            {day}
                          </div>
                        )
                      ...
                      {[1, 2, 3, 4, 5, 6].map((day) => (
                        <div
                          key={day}
                          className="p-3 hover:bg-white/10 cursor-pointer text-sm text-white rounded-lg transition-colors"
                        >
                          {day}
                        </div>
                      ))}
                      ...
                      {[28, 29, 30].map((day) => (
                        <div
                          key={day}
                          className={`p-3 cursor-pointer text-sm rounded-lg transition-colors ${
                            day === 28
                              ? "text-red-400 hover:bg-white/10"
                              : "text-white hover:bg-white/10"
                          }`}
                      ...
                      <div className="p-3 text-white hover:bg-white/10 cursor-pointer text-sm rounded-lg transition-colors">
                        31
                      </div>
                      {[1, 2, 3].map((day) => (
                        <div key={day} className="p-3 text-white/40 text-sm">
                          {day}
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            {
                              name: "Class IT A 1st semester report",
                              date: "01 Oct, 09:00AM",
                            },
                            {
                              name: "Ram leave application",
                              date: "01 Oct, 09:00AM",
                            },
                            {
                              name: "DSA study material",
                              date: "01 Oct, 09:00AM",
                            },
                          ].map((doc, i) => (
                            <div
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            {
                              name: "Class Test Maths IT",
                              class: "IT",
                              time: "10:25 am",
                            },
                            {
                              name: "Unit Test Maths CS",
                              class: "CS",
                              time: "12:36 pm",
                            },
                            {
                              name: "Chapter 3 OS Test CS",
                              class: "CS",
                              time: "04:30 pm",
                            },
                          ].map((test, i) => (
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    {[
                      ...
                      <button
                        key={i}
                        className={`p-4 rounded-xl ${action.color} text-white transition-all duration-200 hover:scale-105 hover:shadow-lg group`}
                      >
              ...
              <div className="flex items-center justify-center h-96">
                <div className="text-center">
                  <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    {React.createElement(
                      sidebarItems.find((item) => item.key === activeTab)
                        ?.icon || Settings,
                      {
